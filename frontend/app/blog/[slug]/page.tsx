...
Değerlendirme sonucu ve gerekçesi, başvuruyu yaptığınız KOSGEB e-Hizmetler (kosgeb.gov.tr) sistemindeki başvuru kaydınızda yer alır. Ayrıca bağlı bulunduğunuz **KOSGEB İl Müdürlüğü** ile görüşerek gerekçe hakkında daha ayrıntılı bilgi alabilirsiniz.
...
| Pasif KOSGEB kaydı | kosgeb.gov.tr üzerinden kaydı aktif hale getirin |
...
`,
    faq: [
      ...
      { q: 'Red nedenini nereden öğrenirim?', a: 'Değerlendirme gerekçesi KOSGEB e-Hizmetler (kosgeb.gov.tr) sistemindeki başvuru kaydınızda yer alır. Ayrıca bağlı olduğunuz KOSGEB İl Müdürlüğü ile görüşerek ayrıntılı bilgi alabilirsiniz.' },
...
1. **KOSGEB kaydı:** kosgeb.gov.tr adresine e-Devlet şifrenizle girip KOSGEB Veri Tabanı kaydınızı yapın/aktifleştirin.
...
- **KOSGEB Kaydı:** kosgeb.gov.tr adresine girerek kaydınızın "Aktif" durumda olduğunu teyit edin. Pasif kayıt başvuruya engel oluşturur.
...
1. kosgeb.gov.tr adresine e-Devlet şifresiyle girin
...
**kosgebhibe.com ile başvuru dosyanızı 499 ₺'ye hazırlayın. Jüriye sunmayı unutmayın: güçlü bir proje özeti, desteklenme oranını 3 kat artırıyor.**
    `,
    faq: [
      { q: 'KOSGEB başvurusu nereden yapılır?', a: 'Başvurular KOSGEB e-Hizmetler sistemi (kosgeb.gov.tr) üzerinden, e-Devlet şifrenizle giriş yapılarak çevrimiçi gönderilir. Önce KOSGEB Veri Tabanı kaydınızın aktif olması gerekir.' },
...
kosgeb.gov.tr üzerinden başvuru formu doldurulur. Proje özeti, iş planı ve destekleyici belgeler yüklenir.
...
kosgeb.gov.tr adresine gidin ve "e-Devlet ile Giriş" butonuna tıklayın. e-Devlet kimliğiniz yoksa e-Devlet'e PTT şubelerinden kayıt yaptırabilirsiniz.
...
**Kaydınız aktifse sıradaki adım başvuru dosyanızı hazırlamak. kosgebhibe.com ile 3–5 dakikada hazır dosya, 499 ₺.**
    `,
    faq: [
      { q: 'KOSGEB kaydı ücretli mi?', a: 'Hayır, KOSGEB Veri Tabanı kaydı tamamen ücretsizdir ve kosgeb.gov.tr üzerinden e-Devlet şifrenizle yapılır.' },
      ...
      { q: 'Kaydım pasif görünüyorsa ne yapmalıyım?', a: 'Pasif kayıt başvuruya engeldir. kosgeb.gov.tr üzerinden işletme beyanınızı güncelleyerek kaydı aktif hale getirebilir, gerekirse bağlı olduğunuz KOSGEB İl Müdürlüğünden destek alabilirsiniz.' },
    ],
  },
